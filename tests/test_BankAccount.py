...
test_1_output = [
    ...
    {'id': 587085106, 'state': 'EXECUTED', 'date': '2018-03-23T10:45:06.972075', 'operationAmount': {'amount': '48223.05', 'currency': {'name': 'руб.', 'code': 'RUB'}}, 'description': 'Закрытие вклада', 'to': 'Счет 41421565395219882431'}
]
test_2_output = [
